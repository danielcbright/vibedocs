...
A lightweight Hono server that auto-discovers all projects under `~/workspace/projects/`, renders their markdown files with syntax highlighting, diagrams, and a table of contents, and live-reloads the browser when files change.
