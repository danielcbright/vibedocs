...
Self-hosted documentation browser for the workspace workspace. Hono backend + React frontend that auto-discovers markdown files across all `~/workspace/projects/` and renders them with rich formatting.
