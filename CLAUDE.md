...
Pick `minimal` for public docs sites (argus.io, etc.) where most readers land on one page and leave. Pick `full` for the live workspace where you want the interactive app.
