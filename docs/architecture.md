...
Scans `~/workspace/projects/` for directories containing `.md` files. Builds a recursive file tree structure for each project. Excludes `node_modules`, `.git`, `dist`, and other non-documentation directories.
...
### Live Reload
1. Chokidar watches `~/workspace/projects/**/*.md`
